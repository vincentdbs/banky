...
INSERT INTO bky_transactions (id, account_id, amount, comment, date, in_bank_date, side, is_interest, sub_category_id, reconciled)
VALUES 
    (1001, 1, -100.00, 'Debit Transaction 1', '2025-01-01', '2025-01-02', 'DEBIT', false, 20, true),
    (1002, 1, -50.25, 'Debit Transaction 2', '2025-01-05', '2025-01-06', 'DEBIT', false, 20, true),
    (1003, 1, -75.50, 'Debit Transaction 3', '2025-01-10', '2025-01-11', 'DEBIT', false, 20, true),
    (1004, 1, -200.00, 'Debit Transaction 4', '2025-01-15', null, 'DEBIT', false, 20, false),
    (1005, 1, -125.75, 'Debit Transaction 5', '2025-01-20', '2025-01-21', 'DEBIT', false, 20, true);

-- CREDIT transactions for account ID 1 (Crédit Agricole)
INSERT INTO bky_transactions (id, account_id, amount, comment, date, in_bank_date, side, is_interest, sub_category_id, reconciled)
VALUES 
    (1006, 1, 1000.00, 'Credit Transaction 1', '2025-01-02', '2025-01-03', 'CREDIT', false, 56, true),
    (1007, 1, 200.50, 'Credit Transaction 2', '2025-01-07', '2025-01-08', 'CREDIT', false, 56, true),
    (1008, 1, 150.25, 'Credit Transaction 3', '2025-01-12', '2025-01-13', 'CREDIT', false, 56, true),
    (1009, 1, 300.00, 'Credit Transaction 4', '2025-01-17', '2025-01-18', 'CREDIT', false, 56, true),
    (1010, 1, 250.75, 'Credit Transaction 5', '2025-01-22', '2025-01-23', 'CREDIT', false, 56, true),
    (1011, 1, 175.50, 'Credit Transaction 6', '2025-01-27', null, 'CREDIT', false, 56, false),
    (1012, 1, 225.25, 'Credit Transaction 7', '2025-02-01', '2025-02-02', 'CREDIT', false, 56, true),
    (1013, 1, 190.00, 'Credit Transaction 8', '2025-02-06', '2025-02-07', 'CREDIT', false, 56, true),
    (1014, 1, 215.50, 'Credit Transaction 9', '2025-02-11', '2025-02-12', 'CREDIT', false, 56, true),
    (1015, 1, 280.25, 'Credit Transaction 10', '2025-02-16', '2025-02-17', 'CREDIT', false, 56, true),
    (1016, 1, 195.75, 'Credit Transaction 11', '2025-02-21', '2025-02-22', 'CREDIT', false, 56, true),
    (1017, 1, 210.50, 'Credit Transaction 12', '2025-02-26', null, 'CREDIT', false, 56, false),
    (1018, 1, 230.00, 'Credit Transaction 13', '2025-03-03', '2025-03-04', 'CREDIT', false, 56, true),
    (1019, 1, 205.25, 'Credit Transaction 14', '2025-03-08', '2025-03-09', 'CREDIT', false, 56, true),
    (1020, 1, 270.50, 'Credit Transaction 15', '2025-03-13', '2025-03-14', 'CREDIT', false, 56, true);

-- DEBIT transaction for account ID 6 (Livret A)
INSERT INTO bky_transactions (id, account_id, amount, comment, date, in_bank_date, side, is_interest, sub_category_id, reconciled)
VALUES 
    (1021, 6, -50.00, 'Debit Transaction Livret A', '2025-01-25', '2025-01-26', 'DEBIT', false, 20, true);
