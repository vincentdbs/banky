package banky.integration;

import banky.guice.TestModule;
import banky.webservices.api.ExampleWs;
 ...
 *
 * This tests differs from an unit tests, cf {@link banky.SampleTest}, because:
 ...
 * Although, to test intensively a function, a unit test is preferred, see {@link banky.SampleTest} for an example.
 *
