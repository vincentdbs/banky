 ...
 */
export default function SecondaryHeaderCell({ children, align = 'left', className = '' }: SubHeaderCellProps) {
  ...
  return (
    <BaseCell className={`bg-slate-100 font-medium ${computeAlignmentClass()} ${className}`}>
      {children}
    </BaseCell>
  );
}
